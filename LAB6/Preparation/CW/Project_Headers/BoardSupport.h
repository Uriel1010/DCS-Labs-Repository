...
#define clear_key_board_flag  PORTA_ISFR = 0x4
...
#define set_blue_light                GPIOB_PDOR = 0x8
#define shift_b_for_next_light        GPIOB_PDOR = GPIOB_PDOR >> 1
#define turn_off_RGB                  GPIOB_PDOR = 0x0
