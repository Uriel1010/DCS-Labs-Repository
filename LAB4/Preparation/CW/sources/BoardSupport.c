...
void InitGPIO()
{
	...
	PORTE_PCR21 = PORT_PCR_MUX(1); // assign PTE29 as GPIO
	GPIOE_PDDR = 0x200038;             // set ports E3,E4,E5 as OUTPUT
	GPIOE_PDOR = 0x00;
	...
	// PushButtons Setup
		...
		PORTD_PCR3 = PORT_PCR_MUX(4); // set PTD3 as input cupture
		...
		PORTB_PCR2 = PORT_PCR_MUX(1); // PTB2 as GPIO
		GPIOB_PDDR = 0x04;			  //  set port B3 as OUTPUT
...
void InitTPM(char x){  // x={0,1,2}
	...
	case 2: 
		...
		//TPM2_C0SC = 0xD4;  //TPM_CnSC_MSB_MASK + TPM_CnSC_ELSB_MASK + TPM_CnSC_CHIE_MASK;
		//TPM2_C0V = 0xFFFF; 
